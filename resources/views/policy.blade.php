...
<head>
    ...
    <title>Orderfiti</title>
</head>

<body>
<main class="main-wrapper relative overflow-hidden">
    <section class="section-features p-28" id="about" style="padding: 48px;">
        <div class="section-space-bottom">
            <div class="container-default">
                ...
                <br>
                <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to info@orderfiti.com. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
                ...
                <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at info@orderfiti.com and they will respond in a reasonable time.</p>
                ...
                <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at info@orderfiti.com.</p>
                <hr>
            </div>
        </div>
    </section>
