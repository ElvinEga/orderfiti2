    ...
    <div class="col-12">
        ...
        <div class="db-card">
            ...
            <div class="db-card-body" id="print">
                ...
                <p class="text-center">
                    <span class="block capitalize mt-4">{{ zones.branch_name }}</span>
                    <span class="block">{{ zones.branch_phone }}</span>
                    <span class="block capitalize mb-6">{{ zones.branch_address }}</span>
                </p>
                <img class="w-48 sm:w-60 mx-auto my-4" :src="zones.qr_code" alt="qrcode">
                <p class="text-center mb-6">
                    <span class="block capitalize">{{ zones.name }}</span>
                </p>
...
export default {
    ...
    computed: {
        zones: function () {
            return this.$store.getters['zones/show'];
        },
        setting: function () {
    ...
    mounted() {
        ...
        this.$store.dispatch('zones/show', this.$route.params.id).then(res => {
